...
class StatisticsController extends Controller
{
    ...
    public function index(){
        ...
        $tariefVan0 = DB::table('retours')->select('credit_amount')->whereMonth('created_at', checkDate(0))->whereYear('created_at', Carbon::now()->year)->sum('credit_amount');
        $tariefVan1 = DB::table('retours')->select('credit_amount')->whereMonth('created_at', checkDate(1))->whereYear('created_at', Carbon::now()->subMonth()->year)->sum('credit_amount');
        $tariefVan2 = DB::table('retours')->select('credit_amount')->whereMonth('created_at', checkDate(2))->whereYear('created_at', Carbon::now()->subMonth()->subMonth()->year)->sum('credit_amount');
        $tariefVan3 = DB::table('retours')->select('credit_amount')->whereMonth('created_at', checkDate(3))->whereYear('created_at', Carbon::now()->subMonth()->subMonth()->subMonth()->year)->sum('credit_amount');
        $tariefVan4 = DB::table('retours')->select('credit_amount')->whereMonth('created_at', checkDate(4))->whereYear('created_at', Carbon::now()->subMonth()->subMonth()->subMonth()->subMonth()->year)->sum('credit_amount');
        $tariefVan5 = DB::table('retours')->select('credit_amount')->whereMonth('created_at', checkDate(5))->whereYear('created_at', Carbon::now()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->year)->sum('credit_amount');
        $tariefVan6 = DB::table('retours')->select('credit_amount')->whereMonth('created_at', checkDate(6))->whereYear('created_at', Carbon::now()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->year)->sum('credit_amount');
        $tariefVan7 = DB::table('retours')->select('credit_amount')->whereMonth('created_at', checkDate(7))->whereYear('created_at', Carbon::now()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->year)->sum('credit_amount');
        $tariefVan8 = DB::table('retours')->select('credit_amount')->whereMonth('created_at', checkDate(8))->whereYear('created_at', Carbon::now()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->year)->sum('credit_amount');
        $tariefVan9 = DB::table('retours')->select('credit_amount')->whereMonth('created_at', checkDate(9))->whereYear('created_at', Carbon::now()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->year)->sum('credit_amount');
        $tariefVan10 = DB::table('retours')->select('credit_amount')->whereMonth('created_at', checkDate(10))->whereYear('created_at', Carbon::now()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->year)->sum('credit_amount');
        $tariefVan11 = DB::table('retours')->select('credit_amount')->whereMonth('created_at', checkDate(11))->whereYear('created_at', Carbon::now()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->subMonth()->year)->sum('credit_amount');
